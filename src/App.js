...
export default function Droplet() {
  ...
  function LocationForm() { // first half of page
    ...
    if (latitude === '' || longitude === '') {
      return (
        <div class="container-fluid text-secondary col-lg mb-1" style={{backgroundColor: '#F08700'}}>
    ...
    <>
      ...
      <footer id="sticky-footer" class="flex-shrink-0 py-3 sticky-bottom text-muted">
          <a href="https://github.com/colelewis/rrsc"><div class="container-fluid">
            <svg xmlns="http://www.w3.org/2000/svg" width="8%" height="8%" fill="white" class="bi bi-github mx-auto d-block fixed-bottom" viewBox="0 0 16 16" role="img">
